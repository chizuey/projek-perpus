            ...
            <?php else: ?>
                <?php foreach (array_slice($activeReservations, 0, 3) as $res): ?>
                    <div class="book-item">
                        ...
                        <div class="status-labels">
                            <span class="status-tag tag-wait"><?php echo ucfirst($res['status']); ?></span>
                        </div>
                    </div>
                <?php endforeach; ?>
                <?php if (count($activeReservations) > 3): ?>
                    <a href="#" class="see-all" style="margin-top: 20px;">Lihat semua (<?php echo count($activeReservations); ?>)</a>
                <?php endif; ?>
            <?php endif; ?>
        </div>
    </div>
